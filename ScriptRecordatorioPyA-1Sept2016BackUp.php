			...
			case 'registrar':
					...
					if ( isset($recordatorio['email_customer']) && $recordatorio['email_customer'] != null ) {
						...
						if ( isset($recordatorio['date_picker']) && $recordatorio['date_picker'] != null ) {
								...
								$dbh = null;
								return print 'handlePress([{"respuesta": 0},{"accion": "registrar"}]);' ;
...
<div id='wrapper' style='width: 760px; background: #fff; margin: 0 auto; padding: 25px; border: 1px solid #58585a;'>
	...
	<div class='initial-section' style='position:relative;'>
		<span class='regards' style='display: inline-block; color: #616161; font-size: 20px; font-weight: 700;'>Estimado ".$recordatorio['name_customer'].",</span>
		...
		<div class='title-product' style='color: #616161; font-size: 18px; font-weight: 600; text-align: center; position:relative; z-index:3;' align='center'>
			".$recordatorio['title_product']." (".$recordatorio['presentation_product']." kg)
		</div>

		<div class='call-to-action' style='padding-bottom: 150px; text-align: center; margin: 30px 0 0; position:relative; z-index:2;' align='center'>
			<a href='https://croquetero.com/cart/add/".$recordatorio['id_variant']."?quantity=1?discount=PyA_GrT52xWZ&properties[Pedido]=Programa y Ahorra&attributes[Ficha]=true&attributes[firstProgramaAhorra]=Si&attributes[Codigo150]=BonoPyA-cf28sac4&attributes[Codigo5]=PyA_GrT52xWZ&attributes[NombreMascota]=".$recordatorio['name_pet']."&attributes[Racion]=".$recordatorio['portion']."&attributes[Titulo]=".$recordatorio['title_product']."&attributes[Presentacion]=".$recordatorio['presentation_product']."&attributes[Frecuencia]=".$recordatorio['frecuency']."&attributes[PrecioLista]=".$recordatorio['price_list']."&attributes[PrecioPyA]=".$recordatorio['price_pya']."&attributes[Comidas]=".$recordatorio['donation']."&attributes[Ahorro]=".$recordatorio['save_money']."' style='display: inline-block; color: #fff; font-size: 20px; font-weight: 600; text-decoration: none; background: #f49500; padding: 20px 40px;'><img src='http://fundacioncroquetero.org/webapp-croquetero/cart-icon.png'> Comprar Producto</a>
		</div>

		<div style='position:absolute; bottom:0px; text-align:center; width:100%; z-index:1;'>
			<img src='http://fundacioncroquetero.org/webapp-croquetero/bgpya_1.png'>
		</div>
	</div>
	...
	<div class='ficha'>
		...
		<p class='email-especial' style='padding-left: 15px; padding-right: 15px; font-size: 14px;'><img src='".$recordatorio['image_product']."' alt='".$recordatorio['title_product']." (".$recordatorio['presentation_product'].")' style='max-width: 100px;'></p>
		...
		<p class='email-especial' style='padding-left: 15px; padding-right: 15px; font-size: 14px;'><span style='color: #f59321; font-weight: bold;'>Presentaci&oacute;n:</span> ".$recordatorio['presentation_product']." Kg.</p>

		<p class='email-especial' style='padding-left: 15px; padding-right: 15px; font-size: 14px;'><img src='https://cdn.shopify.com/s/files/1/0740/0383/files/Mail_R.jpg?15630891721542932741' alt='Raci&oacute;n'><span style='color: #f59321; font-weight: bold;'>   Raci&oacute;n diaria recomendada:</span> ".$recordatorio['portion']." g.</p>

		<p class='email-especial' style='padding-left: 15px; padding-right: 15px; font-size: 14px;'><img src='https://cdn.shopify.com/s/files/1/0740/0383/files/Mail_F.jpg?15630891721542932741' alt='Frecuencia'><span style='color: #f59321; font-weight: bold;'>   Frecuencia recomendada*:</span> ".$recordatorio['frecuency']." días.</p>

		<p class='email-especial' style='padding-left: 15px; padding-right: 15px; font-size: 14px;'><img src='https://cdn.shopify.com/s/files/1/0740/0383/files/Mail_P.jpg?15630891721542932741' alt='Programa y Ahorra'><span style='color: #f59321; font-weight: bold;'>   Precio Programa y Ahora**:</span> $ ".$recordatorio['price_pya']." MXN (Precio regular <del>$ ".$recordatorio['price_list']." MXN</del>).</p>

		<p class='email-especial' style='padding-left: 15px; padding-right: 15px; font-size: 14px;'><img src='https://cdn.shopify.com/s/files/1/0740/0383/files/Mail_D.jpg?15630891721542932741' alt='Donaci&oacute;n anual'><span style='color: #f59321; font-weight: bold;'>   Donaci&oacute;n anual***:</span> ".$recordatorio['donation']." comidas.</p>
	...
	<div class='footer'>
		...
		<div class='email-footer' style='text-align: center;' align='center'>
			...
			<a href='https://www.facebook.com/Croquetero' title='Facebook'><img src='https://cdn.shopify.com/s/files/1/0740/0383/t/12/assets/icono-email-facebook.png?13608627287219887544' alt='Facebook'></a>
							...
							echo "Error: " . $e->getMessage();
							$dbh = null;
							return print 'handlePress([{"respuesta": 0},{"accion": "enviarahora"}]);' ;
						}
...
<div id='wrapper' style='width: 760px; background: #fff; margin: 0 auto; padding: 25px; border: 1px solid #58585a;'>
	...
	<div class='footer'>
		...
		<div class='email-footer' style='text-align: center;' align='center'>
			...
			<a href='https://www.facebook.com/Croquetero' title='Facebook'><img src='https://cdn.shopify.com/s/files/1/0740/0383/t/12/assets/icono-email-facebook.png?13608627287219887544' alt='Facebook'></a>
								...
								return print 'handlePress([{"respuesta": 1},{"accion": "recordatorio"}]);' ;
								#echo "Recordatorios Enviados";
								exit();
							}
							#echo "No hay Recordatorios para hoy";
							return print 'handlePress([{"respuesta": 0},{"accion": "recordatorio"}]);' ;
							exit();
							#return true;
					}
					catch(PDOException $e) {
			...
			default:
				#echo "No es Accion";
				return print 'handlePress([{"respuesta": 0},{"accion": "accion no valida"}]);' ;
				break;
		}
		$dbh = null;
		return print 'handlePress([{"respuesta": 0},{"accion": "accion no valida"}]);' ;
	...
	return print 'handlePress([{"respuesta": 0},{"accion": "action no valid"}]);' ;
	die();

}
#echo "No es GET";
return print 'handlePress([{"respuesta": 0},{"accion": "GET ERROR"}]);' ;
die();