<ol class="breadcrumb">
	<li><a href="<?php echo base_url('adultos/index');?>">SKU'S</a></li>
	<li><a href="<?php echo base_url('adultos/detalles');?>/<?php echo $sku; ?>"><?php echo $sku; ?></a></li>
</ol>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="" data-toggle="modal" data-target="#miModal<?php echo $fila->id; ?>">Editar</a></li>
                    ...
                    <!-- Modal -->
                    <div id="miModal<?php echo $fila->id; ?>" class="modal fade" role="dialog">
                        ...
                        <!-- Modal content-->
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form id="ModalEditarPresentacion" role="form" action="<?php echo base_url('adultos/actualizar');?>" method="post">
                    ...
                    <div id="miModalDelete<?php echo $fila->id; ?>" class="modal fade" role="dialog">
                        ...
                        <!-- Modal content-->
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form id="ModalEliminarPresentacion" role="form" action="<?php echo base_url('#');?>" method="post">
                                  <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila->id; ?>">
                                  <div class="form-group">    
                                    <label for="sku">SKU: <?php echo $fila->sku; ?></label>       
                                  </div>
